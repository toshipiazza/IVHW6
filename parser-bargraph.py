...
if __name__ == '__main__':
    ...
    if (len(sys.argv) == 2):
        ...
        with open('./streamgraph/stacked/data-django.csv', 'w') as csvfile:
            ...
            with open(commitsfile) as f:
                ...
                for month in f:
                    ...
                    for key in extensions:
                        try:
                            sorted_csv[key].append((extensions[key], date))
                        except:
                            sorted_csv[key] = [(extensions[key], date)]
                for obj in sorted_csv:
                    ...
                    for i in sorted_row:
                        if not i[1][-2:] == '15':
                            continue
                        sorted_row1.append(i[0])
                    if len(sorted_row1) > 4:
                        spamwriter.writerow(sorted_row1)
